...
class GfStateRankAvgVsTrend:
    ...
    def __init__(self):
        ...
        self.if_state_avg_7_days = IfStateAvg7Days()
    ...
    def update_grafana_avg_vs_trend_dash(self):
        ...
        dash_string = self.grafana_api.getDashByUid(GfStateRankAvgVsTrend.GRAFANA_DPM_DASH_UID)
